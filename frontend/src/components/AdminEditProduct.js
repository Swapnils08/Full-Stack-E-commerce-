...
const AdminEditProduct = ({
    ...
    const [openDullScreenImage,setOpenDullScreenImage] = useState(false)  
               ...
               <div>
                   {
                       data?.productImage[0] ? (
                          <div className='flex items-center gap-2'>
                           ...
                           <p className='text-red-600 text-xs'>*Plaeas upload product image </p>
                       )
                   }
               </div>
 ...
 {
   openDullScreenImage && (
       <DisplayImage onClose={()=>setOpenDullScreenImage(false)} imgUrl={fullScreenImage}/>
   )
 }
</div>
  )
